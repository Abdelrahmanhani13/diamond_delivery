...
class ApiClient {
  ...
  /// كل الميثودز التلاتة فوق بتنادي هنا. ده بيشيل التكرار اللي كان
  /// موجود (نفس try/catch متكرر 5 مرات)، ومكان واحد بس لو حبينا
  /// نضيف حاجة زي retry أو timeout مخصص لكل request.
