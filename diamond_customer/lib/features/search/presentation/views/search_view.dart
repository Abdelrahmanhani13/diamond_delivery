                        ...
                        child: Row(
                          children: [
                            ...
                            if (_controller.text.isNotEmpty)
                              IconButton(
                                icon: Icon(Icons.close, size: 18.sp, color: AppColors.textSecondary),
                    ...
                    if (state is SearchInitial) {
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('عمليات بحث سابقة', style: AppTextStyles.headingSmall),
                            SizedBox(height: 10.h),
                            Wrap(
                              spacing: 8.w,
                              runSpacing: 8.h,
                              children: _recent
                                  .map((term) => RecentSearchChip(
                                        label: term,
                                        onTap: () {
                      ...
                      return ListView(
                        ...
                        children: [
                          if (vendors.isNotEmpty) ...[
                            Text('المتاجر', style: AppTextStyles.headingSmall),
                            SizedBox(height: 10.h),
                          ...
                          if (products.isNotEmpty) ...[
                            Text('المنتجات', style: AppTextStyles.headingSmall),
                            SizedBox(height: 10.h),
                            GridView.builder(
                              shrinkWrap: true,
