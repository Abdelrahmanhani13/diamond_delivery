...
import 'package:vendor_dashboard/features/auth/data/repositories/vendor_auth_repository_impl.dart';
...
// Profile & Categories
import 'package:vendor_dashboard/features/profile/data/datasources/vendor_categories_remote_data_source.dart';
...
import 'package:vendor_dashboard/features/profile/domain/usecases/get_vendor_categories_use_case.dart';
...
// Orders
import 'package:vendor_dashboard/features/orders/data/datasources/vendor_orders_remote_data_source.dart';
import 'package:vendor_dashboard/features/orders/data/repositories/vendor_orders_repository_impl.dart';
import 'package:vendor_dashboard/features/orders/domain/repositories/vendor_orders_repository.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/accept_vendor_order_use_case.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/get_vendor_order_details_use_case.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/get_vendor_orders_use_case.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/preparing_vendor_order_use_case.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/ready_vendor_order_use_case.dart';
import 'package:vendor_dashboard/features/orders/domain/usecases/reject_vendor_order_use_case.dart';
...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerLazySingleton<VendorCategoriesRemoteDataSource>(
    () => VendorCategoriesRemoteDataSourceImpl(getIt<ApiClient>()),
  );

  getIt.registerLazySingleton<VendorOrdersRemoteDataSource>(
    () => VendorOrdersRemoteDataSourceImpl(getIt<ApiClient>()),
  );
  ...
  getIt.registerLazySingleton<VendorAuthRepository>(
    () => AuthRepositoryImpl(
      remoteDataSource: getIt<VendorAuthRemoteDataSource>(),
      localDataSource: getIt<VendorAuthLocalDataSource>(),
  ...
  getIt.registerLazySingleton<VendorProfileRepository>(
    () => VendorProfileRepositoryImpl(
      getIt<VendorProfileRemoteDataSource>(),
      getIt<VendorCategoriesRemoteDataSource>(),
    ),
  );

  getIt.registerLazySingleton<VendorOrdersRepository>(
    () => VendorOrdersRepositoryImpl(getIt<VendorOrdersRemoteDataSource>()),
  );
  ...
  getIt.registerLazySingleton<VendorRegisterUseCase>(
    () => VendorRegisterUseCase(getIt<VendorProfileRepository>()),
  );
  getIt.registerLazySingleton<GetVendorCategoriesUseCase>(
    () => GetVendorCategoriesUseCase(getIt<VendorProfileRepository>()),
  );
  ...
  // Orders
  getIt.registerLazySingleton<GetVendorOrdersUseCase>(
    () => GetVendorOrdersUseCase(getIt<VendorOrdersRepository>()),
  );
  getIt.registerLazySingleton<GetVendorOrderDetailsUseCase>(
    () => GetVendorOrderDetailsUseCase(getIt<VendorOrdersRepository>()),
  );
  getIt.registerLazySingleton<AcceptVendorOrderUseCase>(
    () => AcceptVendorOrderUseCase(getIt<VendorOrdersRepository>()),
  );
  getIt.registerLazySingleton<RejectVendorOrderUseCase>(
    () => RejectVendorOrderUseCase(getIt<VendorOrdersRepository>()),
  );
  getIt.registerLazySingleton<PreparingVendorOrderUseCase>(
    () => PreparingVendorOrderUseCase(getIt<VendorOrdersRepository>()),
  );
  getIt.registerLazySingleton<ReadyVendorOrderUseCase>(
    () => ReadyVendorOrderUseCase(getIt<VendorOrdersRepository>()),
  );
  ...
  getIt.registerFactory<VendorOrdersCubit>(
    () => VendorOrdersCubit(
      getOrdersUseCase: getIt<GetVendorOrdersUseCase>(),
      getOrderDetailsUseCase: getIt<GetVendorOrderDetailsUseCase>(),
      acceptOrderUseCase: getIt<AcceptVendorOrderUseCase>(),
      rejectOrderUseCase: getIt<RejectVendorOrderUseCase>(),
      preparingOrderUseCase: getIt<PreparingVendorOrderUseCase>(),
      readyOrderUseCase: getIt<ReadyVendorOrderUseCase>(),
    ),
  );

  // ==========================================
  // 6. Location & Addresses Feature
  // ==========================================
